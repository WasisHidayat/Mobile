...
Mobile.setText(findTestObject('Object Repository/Login/android.widget.EditText (2)'), 'receptionist@kaf.co.id', 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Object Repository/Login/android.widget.EditText'), 0)

Mobile.setText(findTestObject('Object Repository/Login/android.widget.EditText'), 'R3cept!#888', 0)
